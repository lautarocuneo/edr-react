  ...
  return (
    <div className = "text-white hover:cursor-default ">
      <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
        <p className='text-[#2A86E2] fond-bold p-2 md:text-3xl text-xl'>ALQUILÁ TUS EQUIPOS</p>
        <h1 className='md:text-6xl sm:text-5xl text-3xl font-bold md:py-6 py-3 mx-3'>Rental de equipos de rodaje y utilería</h1>
        <div>
          <p className='md:text-4xl sm:text-3xl text-xl font-medium md:pb-8 text-[#b3b6b7]'>Revisá nuestro catálogo y armá tu pedido</p>
