...
const Contacto = () => {
  return (
    <div className='bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 h-full text-white'>
      ...
      <div className='max-w-[1240px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-4 py-8 '>
        <div className='flex flex-col items-center p-8 rounded-lg bg-[#252b34]'>
        ...
        <div className='flex items-center justify-center p-8 bg-[#252b34] rounded-lg'>
          <ContactUs />
        </div>
      </div>
    </div>
