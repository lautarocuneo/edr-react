  ...
  return (
    <section className="bg-[#0B0B0C] text-gray-200 py-16 md:py-24">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-12">
        {/* 🔹 Título principal */}
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white mb-12 sm:mb-16 md:mb-20 tracking-tight text-left">
          SERVICIOS
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-16 sm:gap-y-20 gap-x-10 sm:gap-x-16 md:gap-x-28 text-left">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4 sm:mb-6">
              <FaLightbulb className="text-[#2A86E2] text-2xl sm:text-3xl shrink-0" />
              <h3 className="text-xl sm:text-2xl font-bold uppercase tracking-wide text-white">
                Luces
              </h3>
            </div>
            <ul className="space-y-1.5 sm:space-y-2 text-gray-400 font-light text-[13px] sm:text-[14px] md:text-[15px] leading-snug">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4 sm:mb-6">
              <FaCogs className="text-[#2A86E2] text-2xl sm:text-3xl shrink-0" />
              <h3 className="text-xl sm:text-2xl font-bold uppercase tracking-wide text-white">
                Grip
              </h3>
            </div>
          ...
          <div>
            <div className="flex items-center gap-3 mb-4 sm:mb-6">
              <FaCamera className="text-[#2A86E2] text-2xl sm:text-3xl shrink-0" />
              <h3 className="text-xl sm:text-2xl font-bold uppercase tracking-wide text-white">
                Cámara
              </h3>
            </div>
          ...
          {/* 🔵 ÓPTICAS */}
          <div>
            <div className="flex items-center gap-3 mb-4 sm:mb-6 mt-8 md:mt-0">
              <FaCameraRetro className="text-[#2A86E2] text-2xl sm:text-3xl shrink-0" />
              <h3 className="text-xl sm:text-2xl font-bold uppercase tracking-wide text-white">
                Ópticas
              </h3>
            </div>
          ...
          <div>
            <div className="flex items-center gap-3 mb-4 sm:mb-6">
              <FaTools className="text-[#2A86E2] text-2xl sm:text-3xl shrink-0" />
              <h3 className="text-xl sm:text-2xl font-bold uppercase tracking-wide text-white">
                Utilería
              </h3>
            </div>
          ...
          <div>
            <div className="flex items-center gap-3 mb-4 sm:mb-6">
              <FaUserTie className="text-[#2A86E2] text-2xl sm:text-3xl shrink-0" />
              <h3 className="text-xl sm:text-2xl font-bold uppercase tracking-wide text-white">
                Dirección de Fotografía
              </h3>
            </div>
