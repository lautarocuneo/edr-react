...
const NavBar = () => {
  ...
  return (
    <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white'>
      ...
      <div className={nav ? 'absolute left-0 top-20 w-[60%] bg-[#202425] ease-in-out duration-700 z-50' : "absolute -translate-x-full ease-in-out duration-500 top-20 md:hidden z-50"}>
